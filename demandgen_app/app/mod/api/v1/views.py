...
def predict():
    ...
    try:
        for i in range(len(sen)):
            ...
            if "english" in sen[i] :
            ...
            elif "to dial by first name press the star key to dial by last name press the pound key" in sen[i]:
                temp = {}
                temp["command"] = "DTMF" 
                temp["value"] = "#"
                response['action'].append(temp)
            
            elif "extension 8 6 6 9 is not valid. thank you for calling." in sen[i]:
                temp = {}
                temp["command"] = "hangup" 
                temp["value"] = True
                temp['varified'] = False
            ...
            elif "to connect to them directly." in sen[i] and "1" in sen[i-1]:
                temp = {}
                temp["command"] = "DTMF" 
                temp["value"] = 1
                response['action'].append(temp)
            
            elif "there are 8 matching names.peter joy. is that correct?" in sen[i]:
                temp = {}
                temp["command"] = "hangup" 
                temp["value"] = True
                temp['varified'] = False
            ...
            elif "person you wish to reachplease enter it now." in sen[i]:
                temp = {}
                temp["command"] = "DTMF_string"
                temp["value"] = f"{userdetails['fname']} {userdetails['lname']}"
                response['action'].append(temp)
            
            elif "spell" in sen[i] or "enter" in sen[i] or "know" in sen[i] or "press" in sen[i] or "dial" or "do" in sen[i]:
                print("*"*20)
                print("Line 171 condition : If spell, enter , know , do press and dial found in sen[i]")
                print("***************************")
                if "last and first" in sen[i] or "last name and first" in sen[i] or "last name first name" in sen[i] or "last in first name" in sen[i] or "last name and then spell the first name" in sen[i] or "last name first" in sen[i]:
                ...
                elif "telephone key pad to enter the first two or more letters of the person's last name" in sen[i]:
                    temp = {}
                    temp["command"] = "DTMF_string"
                    temp["value"] = f"{userdetails['lname']}"
                    response['action'].append(temp)
                ...
                elif "for a dial by name directory" in sen[i] and "4" in sen[i-1]:
                    temp["command"] = "DTMF"
                    temp["value"] = 4
                    response['action'].append(temp)
                
                elif "glendale california our offices" in sen[i] and "dial by name directory" in sen[i]:
                    temp["command"] = "DTMF"
                    temp["value"] = 8
                    response['action'].append(temp)
                
                elif "if you know your party's extension you may dial it at any time for a dial by name directory" in sen[i] and "press pound" in sen[i+1]:
                    temp["command"] = "DTMF"
                    temp["value"] = "#"
                    response['action'].append(temp)
                
                elif "you may dial it at anytime to reach the company name directory please" in sen[i] and "press 3" in sen[i+1]:
                    temp["command"] = "DTMF"
                    temp["value"] = 3
                    response['action'].append(temp)
                ...
                elif "for the company directory, press the pound key." in sen[i]:
                    temp["command"] = "DTMF"
                    temp["value"] = "#"
                    response['action'].append(temp)
                    ...
                    if "staff directory" in sen[i] or "to consult our directory" in sen[i] or "to access our company directory" in sen[i] or  "to the local at 17 directory" in sen[i] or "name directory" in sen[i]:
                        ...
                        temp["value"] = 1
                        response['action'].append(temp)
                    elif "the company directory please dial 1 otherwise dial zero for the operato" in sen[i]:
                        temp["command"] = "DTMF" 
                        temp["value"] = 1
                        response['action'].append(temp)
                    ...
                    elif "for the staff directory. if you wishto reach a patient" in sen[i] and "1" in sen[i]:
                        temp["command"] = "DTMF"
                        temp["value"] = 1
                        response['action'].append(temp)
                    ...
                    if value:
                        ...
                        temp["command"] = "DTMF"
                        temp["value"] = 4 if "dial 4 for the dial by name directory" in sen[i] else strtoint.get(value[0])
                        response['action'].append(temp)
                    elif "name" in sen[i]:
                        print("*"*20)
                ...
                elif "if you do the full name or number of the person you're trying to reach please" in sen[i] and "press 1" in sen[i+1]:
                    temp["command"] = "DTMF" 
                    temp["value"] = 1
                    response['action'].append(temp)
                
                elif "if you know the full name or number of the person you're trying to reach please" in sen[i] and "press 1" in sen[i+1]:
                    temp["command"] = "DTMF" 
                    temp["value"] = 1
                    response['action'].append(temp)
                
                elif "if you don't know the extension" in sen[i] and "press 1" in sen[i+1]:
                    temp["command"] = "DTMF" 
                    temp["value"] = 1
                    response['action'].append(temp)
            ...
            elif "no the last in first name then" in sen[i] and "press pound" in sen[i+1]:
                temp = {}
                temp["command"] = "hangup" 
                temp["value"] = True
                temp['varified'] = False
            ...
            elif "please state the name of the person you wish to speak with" in sen[i]:
                temp = {}
                temp["command"] = "hangup" 
                temp["value"] = True
                temp['varified'] = False
            ...
            elif "good morning Lobby security Prasad speaking".lower() in sen[i]:
                temp = {}
                temp["command"] = "hangup" 
                temp["value"] = True
                temp['varified'] = False
